      ...
      >
        <DialogHeader className="text-center flex flex-col items-center justify-center">
          ...
          <DialogDescription className="text-xs md:text-sm text-neutral-500 font-manrope text-center leading-relaxed mt-2">
            ...
            <strong className="font-semibold text-neutral-900">"{expenseDescription}"</strong>? This
            will recalculate all balances and cannot be undone.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex gap-2.5 md:gap-3 mt-6">
          ...
          <Button
            ...
            disabled={isDeleting}
            className="flex-1 h-10 md:h-11 text-xs md:text-sm font-semibold font-manrope text-white border border-white/35 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
