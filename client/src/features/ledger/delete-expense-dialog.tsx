      ...
      >
        <DialogHeader className="text-center flex flex-col items-center justify-center gap-1.5">
          ...
          <DialogDescription className="text-sm text-neutral-400 font-light text-center leading-relaxed mt-1">
            Are you sure you want to delete <span className="font-semibold text-neutral-700">"{expenseDescription}"</span>? This will recalculate all balances and cannot be undone.
          </DialogDescription>
        </DialogHeader>
