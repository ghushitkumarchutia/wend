...
export const itineraryEvents = pgTable(
  ...
  (t) => [
    index('itinerary_events_trip_start_idx').on(t.tripId, t.startAt),
  ],
);
...
export const itineraryEventsRelations = relations(
  itineraryEvents,
  ({ one }) => ({
    trip: one(trips, {
...
export const itineraryFlightDetailsRelations = relations(
