...
--> statement-breakpoint
CREATE TABLE "template_flight_details" (
	"id" text PRIMARY KEY NOT NULL,
	"event_id" text NOT NULL,
	"airline" text,
	"flight_number" text,
	...
	"seat" text,
	"baggage_allowance" text,
	CONSTRAINT "template_flight_details_event_id_unique" UNIQUE("event_id")
);
--> statement-breakpoint
...
ALTER TABLE "template_flight_details" ADD CONSTRAINT "template_flight_details_event_id_template_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."template_events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "unique_active_email" ON "user" USING btree ("email") WHERE "user"."deleted_at" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "unique_expense_user" ON "expense_participants" USING btree ("expense_id","user_id");--> statement-breakpoint
