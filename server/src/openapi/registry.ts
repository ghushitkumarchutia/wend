...
import { signUpSchema, signInSchema, forgotPasswordSchema, resetPasswordSchema } from '../shared/schemas/authSchemas.js';
import { createTripSchema, updateTripSchema, inviteMemberSchema } from '../shared/schemas/tripsSchemas.js';
import { createEventSchema, updateEventSchema } from '../shared/schemas/itinerarySchemas.js';
import { logExpenseSchema, updateExpenseSchema, settleUpSchema } from '../shared/schemas/ledgerSchemas.js';
...
import { createTemplateSchema, updateTemplateSchema, changeVisibilitySchema, cloneTemplateSchema } from '../shared/schemas/templatesSchemas.js';
import { updateProfileSchema, changePasswordSchema, changeEmailSchema, deleteAccountConfirmSchema } from '../shared/schemas/accountSchemas.js';
